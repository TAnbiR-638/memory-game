(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const c of a)if(c.type==="childList")for(const N of c.addedNodes)N.tagName==="LINK"&&N.rel==="modulepreload"&&o(N)}).observe(document,{childList:!0,subtree:!0});function n(a){const c={};return a.integrity&&(c.integrity=a.integrity),a.referrerPolicy&&(c.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?c.credentials="include":a.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function o(a){if(a.ep)return;a.ep=!0;const c=n(a);fetch(a.href,c)}})();const F=10;var D;const ne=((D=window.APP_CONFIG)==null?void 0:D.apiBaseUrl)||"http://localhost:3000/api",P="memory-game-token",J="memory-game-guest-leaderboards-v1",H=["🍓","🚀","🎵","⚽","🐱","🌈","🎲","⭐","🍎","🍋","🍇","🍉","🥝","🍍","🥑","🥕","🌶️","🌽","🍄","🥜","🍪","🍩","🍫","🍰","🧁","🍿","🥨","🧇","🥞","🍔","🍕","🌭","🍟","🥪","🌮","🍣","🍤","🍜","🍙","🍱","🧃","🥤","☕","🍵","🎸","🎹","🥁","🎺","🎻","🎤","🎯","🏀","🏈","🎾","🏐","🏓","🥊","🥎","🏹","🪁","🧩","🎨","🎬","🎮","🕹️","🧸","🪀","🪄","🔔","💎","🔮","🧭","⌛","🛰️","🛸","🛶","🚲","🚁","🚢","🗺️"],R=[{key:"easy-2x2",difficulty:"Easy",rows:2,cols:2,maxTimeSeconds:60},{key:"easy-4x4",difficulty:"Easy",rows:4,cols:4,maxTimeSeconds:120},{key:"medium-4x6",difficulty:"Medium",rows:4,cols:6,maxTimeSeconds:180},{key:"medium-6x6",difficulty:"Medium",rows:6,cols:6,maxTimeSeconds:300},{key:"hard-6x8",difficulty:"Hard",rows:6,cols:8,maxTimeSeconds:480},{key:"hard-8x8",difficulty:"Hard",rows:8,cols:8,maxTimeSeconds:600}],K=document.querySelector("#app");if(!K)throw new Error("App root not found");K.innerHTML=`
